...
import { Camera, User, Lock, Bell } from '@phosphor-icons/react';
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-6">
                <div className="flex-1 flex flex-col gap-2">
                  ...
                  <input type="text" defaultValue="Nguyễn Văn" className="w-full px-4 py-2.5 text-sm border border-slate-200 rounded-lg outline-none focus:border-blue-500 bg-white" />
                </div>
                <div className="flex-1 flex flex-col gap-2">
                  <label className="text-sm font-semibold text-slate-700">
                    Tên <span className="text-red-500">*</span>
                  </label>
                  <input type="text" defaultValue="A" className="w-full px-4 py-2.5 text-sm border border-slate-200 rounded-lg outline-none focus:border-blue-500 bg-white" />
                </div>
              </div>
