...
const Toggle = ({ defaultChecked = true }: { defaultChecked?: boolean }) => {
  ...
  return (
    <button 
      ...
      className={`w-9 h-5 rounded-full relative transition-colors shadow-inner shrink-0 ${checked ? 'bg-blue-600' : 'bg-slate-200'}`}
    >
  ...
  return (
    <div>
      ...
      >
        ...
        <p className="font-bold text-sm">Lưu cài đặt thông báo thành công!</p>
      </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between p-4 border border-slate-200 rounded-xl hover:border-blue-200 hover:shadow-sm transition-all bg-white">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-medium text-slate-500 mt-0.5">Thông báo khi có bệnh nhân đặt lịch hẹn mới tại phòng khám</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 border border-slate-200 rounded-xl hover:border-blue-200 hover:shadow-sm transition-all bg-white">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-slate-900">Yêu cầu hủy lịch hẹn</h3>
                      <p className="text-xs font-medium text-slate-500 mt-0.5">Thông báo khi bác sĩ hoặc bệnh nhân hủy lịch hẹn</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <div className="flex flex-col items-center gap-1.5 w-[72px]">
                ...
                <div className="flex items-center justify-between p-4 border border-slate-200 rounded-xl hover:border-blue-200 hover:shadow-sm transition-all bg-white">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-slate-900">Thay đổi nhân sự</h3>
                      <p className="text-xs font-medium text-slate-500 mt-0.5">Thông báo khi có nhân viên mới đăng ký hoặc cập nhật lịch làm việc</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <div className="flex flex-col items-center gap-1.5 w-[72px]">
                ...
                <div className="flex items-center justify-between p-4 border border-slate-200 rounded-xl hover:border-blue-200 hover:shadow-sm transition-all bg-white">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-slate-900">Giao dịch tài chính</h3>
                      <p className="text-xs font-medium text-slate-500 mt-0.5">Thông báo khi phát sinh hóa đơn mới hoặc khoản chi phí lớn</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <div className="flex flex-col items-center gap-1.5 w-[72px]">
                ...
                <div className="flex items-center justify-between p-4 border border-slate-200 rounded-xl hover:border-blue-200 hover:shadow-sm transition-all bg-white">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-medium text-slate-500 mt-0.5">Cảnh báo đăng nhập lạ, bảo trì hệ thống hoặc cập nhật định kỳ</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <div className="flex flex-col items-center gap-1.5 w-[72px]">
